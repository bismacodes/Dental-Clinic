...
@section('content')
    ...
    <x-ui.page-title title="Add New Patient" subtitle="Register a new patient record" />
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            <x-ui.input name="othername" label="Other Name" placeholder="Optional" />
                        </div>
                        ...
                        <div class="col-md-6">
                            <x-ui.input name="date_of_birth" label="Date of Birth" type="date"
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <x-ui.input name="phone_no" label="Phone Number" type="tel" placeholder="e.g. 08012345678"
                                required />
                        </div>

                        <div class="col-md-6">
                            <x-ui.input name="relative_phone_no" label="Relative Phone" type="tel"
                                placeholder="Emergency contact" required />
                            <div class="form-text">Used in emergencies only</div>
                        </div>
